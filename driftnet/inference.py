"""
Use this script for inference/testing a driftnet model.
...
def get_test_set(
    ...
    Args:
        ...
        dataset_kwargs: dict
            Additional arguments for dataset as in driftnet.problems.base.get_dataset.
    """
