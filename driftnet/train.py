"""
This script trains a driftnet or pretrains Poseidon on a PDE dataset.
...
from driftnet.trainer import TrainingArguments, Trainer
from transformers import EarlyStoppingCallback
from driftnet.model import ScOT, ScOTConfig
from mpl_toolkits.axes_grid1 import ImageGrid
from driftnet.problems.base import get_dataset, BaseTimeDataset
from driftnet.utils import get_num_parameters, read_cli, get_num_parameters_no_embed
from driftnet.metrics import relative_lp_error
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train driftnet or pretrain Poseidon.")
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Set this to a str pointing to a HF Hub model checkpoint or a directory with a driftnet checkpoint if you want to finetune.",
    )
    parser.add_argument(
